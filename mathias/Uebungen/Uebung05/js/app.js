...
var Anwendung = {
    ...
    setScene: function ()
    {
        ...
        this.renderer.addObject(wuerfel.geometrie, wuerfel.aussehen, this.renderer.getShaderprogram("sp_Phong"), translationsmatrix);   // In 3D-Szene

        // Kugel in Szene laden
        var translationsMatrix = mat4.create();                                             // Einheitsmatrix
        var verschiebungsVektor = vec3.fromValues(0.55, 0, 0);                              // Verschiebungsvektor
        mat4.translate(translationsMatrix, translationsMatrix, verschiebungsVektor);        // Translation
        this.renderer.addObject(kugel.geometrie, kugel.aussehen, this.renderer.getShaderprogram("sp_Phong") ,translationsMatrix);       // In 3D-Szene
    },
